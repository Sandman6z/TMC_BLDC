...
tmc4671_writeInt(0, TMC4671_ADC_I0_SCALE_OFFSET, 0x01008234);
tmc4671_writeInt(0, TMC4671_ADC_I1_SCALE_OFFSET, 0x0100825D);

// Open loop settings
tmc4671_writeInt(0, TMC4671_OPENLOOP_MODE, 0x00000000);
tmc4671_writeInt(0, TMC4671_OPENLOOP_ACCELERATION, 0x0000003C);
tmc4671_writeInt(0, TMC4671_OPENLOOP_VELOCITY_TARGET, 0x00000014);

// Feedback selection
tmc4671_writeInt(0, TMC4671_PHI_E_SELECTION, 0x00000002);
tmc4671_writeInt(0, TMC4671_UQ_UD_EXT, 0x00000198);
