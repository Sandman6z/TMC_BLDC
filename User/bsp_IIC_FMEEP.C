...
void I2C_EE_ByteWrite(u8 pBuffer, u16 WriteAddr)
{
  ...
  while((!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_MODE_SELECT))&ms_timeout){ClearWDG();}  
  if(!ms_timeout)
  {
	  I2C_GenerateSTART(I2C1, ENABLE);
	  ms_timeout=5;
  ...
  while((!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED))&ms_timeout){ClearWDG();}
      
  /* Send the EEPROM's internal address to write to */
  I2C_SendData(I2C1, (WriteAddr>>8)&0xff);
  ms_timeout=5;
  /* Test on EV8 and clear it */
  while((!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_BYTE_TRANSMITTED))&ms_timeout){ClearWDG();}
...
//  I2C_Cmd(I2C1, ENABLE);
  ...
  ms_timeout=5;
  /* Test on EV6 and clear it */
  while((!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_RECEIVER_MODE_SELECTED))&ms_timeout){ClearWDG();}
  ...
  /* While there is data to be read */
    ...
    while((!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_BYTE_RECEIVED))&ms_timeout){ClearWDG();}  
    {      
